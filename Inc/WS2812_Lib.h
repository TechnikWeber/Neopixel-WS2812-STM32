...
#define WS2812_NUM_LEDS_CH1		5  //Wie viele LEDs auf dem Streifen sind...

#define  WS2812_TIM_PRESCALE    0  // F_T3  = 72 MHz (13.88ns)
#define  WS2812_TIM_PERIODE   	89  // F_PWM = 800 kHz (1.25us)

#define  WS2812_LO_TIME        	29  // 29 * 13,9ns = 0.43us, eventuell 25
#define  WS2812_HI_TIME        	58  // 58 * 13.9ns = 0.81us, eventuell 62
...
//Puffer für alle LEDs
WS2812_RGB_t WS2812_LED_BUF_CH1[WS2812_NUM_LEDS_CH1];

//PWM Puffer 3 Farben a 8 Bit = 24Bit zur Sicherheit 2 Reset Pulse
